...
for agent = 1 : AgentNumber
    RawValues(1,agent) = str2num(fgetl(mbed(agent))) - sensorBG(agent) + iniBG;
...
for agent = 1 : AgentNumber
    RawValues(counter,agent) = str2num(fgetl(mbed(agent))) - sensorBG(agent) + iniBG;
