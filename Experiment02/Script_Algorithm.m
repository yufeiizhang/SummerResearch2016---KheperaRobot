...
%% UPDATE FIGURE
plot(61,46,'kx',rc(1),rc(2),'co',r1(1),r1(2),'g*',r2(1),r2(2),'b*',r3(1),r3(2),'k*',r4(1),r4(2),'r*','MarkerSize',10,'MarkerFaceColor','b')
...
%Formation Control
[r1,r2,r3,r4] = fun_jacobi(r1,r2,r3,r4,rc);
